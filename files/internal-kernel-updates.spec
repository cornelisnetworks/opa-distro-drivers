...
Summary:        Extra kernel modules for OmniPath
...
%description
Updated kernel modules for OPA
...
(targetdir=$RPM_BUILD_ROOT%{_includedir}/uapi/rdma
 ...
 srcdir=$PWD
 cd %kdir
 sh ./scripts/headers_install.sh $srcdir/include/uapi/rdma/rdma_user_ioctl.h $targetdir/rdma_user_ioctl.h
 sh ./scripts/headers_install.sh $srcdir/include/uapi/rdma/rdma_user_ioctl_cmds.h $targetdir/rdma_user_ioctl_cmds.h
 targetdir=$RPM_BUILD_ROOT%{_includedir}/uapi/rdma/hfi
 mkdir -p $targetdir
 sh ./scripts/headers_install.sh $srcdir/include/uapi/rdma/hfi/hfi1_user.h $targetdir/hfi1_user.h
 sh ./scripts/headers_install.sh $srcdir/include/uapi/rdma/hfi/hfi1_ioctl.h $targetdir/hfi1_ioctl.h)
...
%changelog
* Thu Mar 13 2025 Dennis Dalessandro <dennis.dalessandro@cornelisnetworkscom>
- Overhaul spec file to work for RHEL 9.5 and new OPXS package
* Tue Mar  7 2023 Dennis Dalessandro <dennis.dalessandro@cornelisnetworks.com>
- Fix headers_install usage 
