...
#define JKR_SEND_CTXT_CHECK_SLID_MASK_MASK (0xFFFFFFull)
#define JKR_SEND_CTXT_CHECK_SLID_MASK_SHIFT (32)
#define JKR_SEND_CTXT_CHECK_SLID_VALUE_MASK (0xFFFFFFull)
#define JKR_SEND_CTXT_CHECK_SLID_VALUE_SHIFT (0)
...
#define JKR_SEND_DMA_CFG_SIIDX (JKR_TXE + 0x000000300C00)
